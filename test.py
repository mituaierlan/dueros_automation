...
class driver_configure():
    def get_driver(self):
        ...
        self.desired_caps['appPackage'] = 'com.baidu.xiaoduos.personalcenter'     # APK包名
        self.desired_caps['appActivity'] = '.activity.MainActivity'     # 被测程序启动时的Activity
        ...
        self.desired_caps['udid'] = '192.168.0.102:5555'
        self.driver = webdriver.Remote("http://127.0.0.1:4723/wd/hub",self.desired_caps)
        self.desired_caps['automationName'] = 'UIautomator2'
        return self.driver


driver = driver_configure().get_driver()
driver.quit()
print('finish')
